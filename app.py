...
def keyword_chips(keywords: list) -> None:
    if not keywords:
        H('<span style="color:var(--text-dim);font-size:0.82rem;font-family:var(--font-mono)">No suspicious keywords detected.</span>')
        return
...
def render_full_result(result: dict) -> None:
    ...
    if kws:
        ...
        kw_chips_html = '<span style="color:var(--text-dim);font-size:0.82rem;font-family:var(--font-mono)">No suspicious keywords detected.</span>'
